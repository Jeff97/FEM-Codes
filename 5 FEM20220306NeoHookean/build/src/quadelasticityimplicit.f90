...
! #include "metis.h"
      ...
      INTEGER :: ndim=2
      INTEGER :: ndof=2
      INTEGER :: npElem=4 ! number of nodes per element
      INTEGER :: io, nn, iter
      ...
      DOUBLE PRECISION :: F(2,2), b(3,3), Stress(4), FInv(2,2)
      ...
      INTEGER :: forAssyVec(8), elemDofGlobal(8)
   ...
   !   ! pcout << " nz_unneeded  = " <<  info.nz_unneeded << endl;
      ...
      Do iter=1, 5
        ...
        LoopElem: DO ee=1, nElem
          ...
          call StiffnessResidualElasticityLinearQuad(xNode, yNode, elemData, timeData, dispElem, veloElem, acceElem, &
          F, b, Stress, Elasticity, Klocal, Flocal)
          ...
          write(*,*) "b: \n"
          DO ii=1,3
            write(*,*) b(ii,1), b(ii,2), b(ii,3)
          END DO

          write(*,*) "Elasticity: \n"
          DO ii=1,9
            write(*,*) Elasticity(ii,1), Elasticity(ii,2), Elasticity(ii,3), Elasticity(ii,4), &
            Elasticity(ii,5), Elasticity(ii,6), Elasticity(ii,7), Elasticity(ii,8), Elasticity(ii,9)
          END DO
